...
Build a peer-to-peer file store product (protocol) to achive the distribute storage cheaper, faster, safer, and more privacy.

研发一款端到端的安全、高效、低成本、高隐私的分布式文件存储产品(协议)。
